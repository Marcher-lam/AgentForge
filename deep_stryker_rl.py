...
targets = [
    ("rlforge/types/transition.py", "tests/unit/rlforge/"),
    ("rlforge/errors.py", "tests/unit/rlforge/"),
    ("rlforge/envs/base.py", "tests/unit/rlforge/"),
    ("rlforge/buffers/replay.py", "tests/unit/rlforge/"),
    ("rlforge/buffers/rollout.py", "tests/unit/rlforge/"),
    ("rlforge/networks/mlp.py", "tests/unit/rlforge/"),
    ("rlforge/training/mixin.py", "tests/unit/rlforge/"),
    ("rlforge/training/callbacks.py", "tests/unit/rlforge/"),
    ("rlforge/algorithms/dqn/trainer.py", "tests/unit/rlforge/"),
    ("rlforge/algorithms/ppo/trainer.py", "tests/unit/rlforge/"),
]
