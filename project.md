...
| Tab | 功能描述 |
|-----|----------|
| **对话** | 会话列表（单聊/群聊切换）+ 消息面板 + WebSocket 实时通信。启动自带"AI 专家团队"群聊（8 个预设角色）。支持删除会话（带确认）、导出聊天记录（JSON 下载）、群聊多 Agent 讨论 |
...
| # | 角色 | system_prompt 要点 | 进化 | RL |
|---|------|-------------------|------|-----|
| 1 | 程序员 | 全栈工程、系统设计、代码质量、SOLID | 30代 | PPO 300步 |
| 2 | 哲学家 | 多元哲学视角、追问式思考、技术哲学 | 40代 | REINFORCE 500步 |
| 3 | 数学家 | 线性代数、概率论、形式化推导 | 50代 | DQN 500步 |
| 4 | 机器学习算法工程师 | XGBoost、特征工程、集成学习、sklearn | 35代 | PPO 400步 |
| 5 | 深度学习算法工程师 | Transformer、PyTorch、CV/NLP、消融实验 | 40代 | PPO 500步 |
| 6 | 强化学习算法工程师 | PPO/DQN/SAC、奖励设计、Gymnasium | 50代 | PPO 1000步 |
| 7 | C++工程师 | C++17/20、模板元编程、并发、零成本抽象 | 30代 | DQN 400步 |
| 8 | 大模型引擎推理工程师 | KV Cache、量化、并行推理、vLLM/TensorRT | 35代 | PPO 500步 |
| 9 | 前端工程师 | React 19、TypeScript、Fiber、性能优化 | 30代 | PPO 300步 |
